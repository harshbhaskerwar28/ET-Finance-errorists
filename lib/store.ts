...
interface AppState {
  ...
  setDashboardCache: (data: Partial<AppState['dashboardCache']>) => void
  setPortfolioCache: (data: Partial<AppState['portfolioCache']>) => void
}
...
export const useAppStore = create<AppState>()(
  persist(
    (set) => ({
      ...
      setDashboardCache: (data: Partial<AppState['dashboardCache']>) => set((state) => ({
        dashboardCache: { ...state.dashboardCache, ...data }
      })),

      setPortfolioCache: (data: Partial<AppState['portfolioCache']>) => set((state) => ({
        portfolioCache: { ...state.portfolioCache, ...data }
      })),
    }),
    {
      name: 'et-ai-storage',
